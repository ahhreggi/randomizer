...
@Component({
  selector: 'app-bob-ross-ipsum',
  templateUrl: './bob-ross-ipsum.component.html',
  styleUrls: ['./bob-ross-ipsum.component.css']
})
export class BobRossIpsumComponent implements OnInit {
  ...
  getIpsum(): void {
    ...
    let newIndex = Math.floor(Math.random() * this.available.length);
    this.ipsum += this.available[newIndex] + " ";
    this.available.splice(newIndex, 1);
    this.ipsum.trim();
    this.copied = false;
    this.counter++;
  }
  ...
  copyString(): void {
    this.clipboard.copy(this.ipsum);
    this.copied = true;
  }
